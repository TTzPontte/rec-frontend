import Select, { SelectOption } from "@iso/components/shared/template/uielements//select";
...
export const SelectPersonalizado = ({
  texto,
  valorCampo,
  iconeLabel,
  lista,
    ...
    <div>
      ...
      <div className="divInput">
        <Select
          ...
          onChange={(value) => handleChange({ target: { id: idCampo, value } })}
        >
          {lista.map((arg) => (
            <SelectOption value={arg}>{arg}</SelectOption>
          ))}
        </Select>
      </div>
